...
! function(t, e) {
        ...
        X = function() {
            ...
            return i.next = function() {
                ...
                if (!(t > this._items.length - 1 || t < 0))
                    if (this._isSliding) M.one(this._element, "slid.bs.carousel", (function() {
                        return e.to(t)
                    }));
                    else {
    ...
    M.on(document, "click.bs.carousel.data-api", "[data-slide], [data-slide-to]", X.dataApiClickHandler), M.on(window, "load.bs.carousel.data-api", (function() {
        for (var t = Q.find('[data-ride="carousel"]'), e = 0, n = t.length; e < n; e++) X.carouselInterface(t[e], w(t[e], "bs.carousel"))
    })), _((function() {
        var t = v();
        if (t) {
            var e = t.fn[V];
    ...
    function ut(t) {
        ...
        for (var e = ft(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;) n = (t = t.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
    ...
    var _e = "tooltip",
        ...
        ke = function() {
            ...
            return i.enable = function() {
                ...
                if (null !== t) return "object" == typeof e && u(e) ? (e.jquery && (e = e[0]), void(this.config.html ? e.parentNode !== t && (t.innerHTML = "", t.appendChild(e)) : t.textContent = e.textContent)) : void(this.config.html ? (this.config.sanitize && (e = ve(e, this.config.allowList, this.config.sanitizeFn)), t.innerHTML = e) : t.textContent = e)
            }, i.getTitle = function() {
    ...
    var He = {
        ...
        Be = function() {
            ...
            return i.show = function() {
                ...
                return t = n({}, Re, U.getDataAttributes(this._element), "object" == typeof t && t ? t : {}), d("toast", t, this.constructor.DefaultType), t
            }, i._setListeners = function() {
                var t = this;
